...
@Mod(modid = Reference.MOD_ID, name = Reference.MOD_NAME, version = Reference.VERSION, guiFactory = "com.darkliz.lizzyanvil.config.GuiFactoryLizzyAnvil")
public class LizzyAnvil {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		/**
		 * effectively prevents the anvil gui and container from being
		 * opened,but still acts like a container for placing blocks on it (must
		 * be sneaking)
		 * 
		 */
